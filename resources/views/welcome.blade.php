...
<body class="antialiased bg-gray-50 min-h-screen flex flex-col">
    <div class="hero-bg py-16">
        <div class="max-w-3xl mx-auto text-center text-white">
            ...
            @else
                <a href="{{ route('login') }}" class="inline-block px-6 py-3 bg-white text-blue-700 font-semibold rounded shadow hover:bg-blue-50 transition">Log Masuk</a>
            @endauth
        </div>
    </div>
        ...
        <div class="max-w-4xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white rounded-xl shadow p-6 text-center">
                    ...
                    <h3 class="font-semibold text-lg mb-2">Aduan Kerosakan</h3>
                    <p class="text-gray-500 text-sm">Fasiliti, bangunan, & sistem.</p>
                </div> 
                <div class="bg-white rounded-xl shadow p-6 text-center">
                    <div class="mb-3">
                ...
                <div class="bg-white rounded-xl shadow p-6 text-center">
                    ...
                    <h3 class="font-semibold text-lg mb-2">Status Aduan</h3>
                    <p class="text-gray-500 text-sm">Jejak status aduan anda dengan mudah.</p>
                </div>
            </div>
