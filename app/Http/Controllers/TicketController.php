...
class TicketController extends Controller
{
    ...
    public function create()
    {
        ...
        $statuses = TicketStatus::orderBy('name')->pluck('name', 'id');
        $reportTypes = ReportType::orderBy('name')->pluck('name','id');
        return view('ticket.create', compact('categories', 'departments', 'vendors', 'statuses', 'reportTypes'));
    }
    ...
    public function getReportTypes($category_id)
    {
